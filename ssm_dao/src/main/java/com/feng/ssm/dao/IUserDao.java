...
public interface IUserDao {
    ...
    @Results({
            ...
            @Result(property = "roles", column = "id", javaType = java.util.List.class, many = @Many(select = "com.feng.ssm.dao.IRoleDao.findRoleByUserId"))
    })
    public UserInfo findByUsername(String usernme) throws Exception;
